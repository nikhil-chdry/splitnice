      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.3fr_0.7fr] lg:items-end">
          ...
          <div className="rounded-3xl bg-lime p-7 text-ink">
            ...
            <p className="my-6 text-5xl font-bold tracking-tight">₹2,350</p>

            <div className="mb-7 flex items-center justify-between border-t border-ink/15 pt-5 text-sm">
              <span>Across 3 people</span>
              <span>4 payments</span>
            </div>

            <button className="w-full rounded-full bg-brand px-6 py-4 font-semibold text-white transition hover:scale-[1.02]">
